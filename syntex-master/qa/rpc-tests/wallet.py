...
#   c) node1 mines 32 blocks, so now node 0 has 500000SYX, node 1 has 4250SYX, node2 has none.
#   d) node0 sends 601 SYX to node2, in two transactions (301 SYX, then 300 SYX).
