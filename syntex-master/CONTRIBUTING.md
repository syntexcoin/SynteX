...
The SynteX project operates an open contributor model where anyone is
...
The following applies to code changes to the SynteX project, and is not to be
confused with overall SynteX Network Protocol consensus changes.

Whether a pull request is merged into SynteX rests with the project merge
...
Patches that change SynteX consensus rules are considerably more involved than
...
Where a patch set proposes to change the SynteX consensus, it must have been
...
The project leader is the release manager for each SynteX Core release.
