...
This means one can have an always-on syntexd instance running, and another local syntexd/syntex-qt instance which connects to this node and receives blocks from it.
