...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SynteX Core syntex-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  syntex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded syntex transaction") + "\n" +
                               "  syntex-tx [options] -create [commands]   " + _("Create hex-encoded syntex transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded syntex transaction
