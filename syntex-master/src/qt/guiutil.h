...
/** Utility functions used by the SynteX Qt UI.
 */
namespace GUIUtil
{
...
// Render SYX addresses in monospace font
...
// Parse "syntex:" URI into recipient object, return true on successful parsing
