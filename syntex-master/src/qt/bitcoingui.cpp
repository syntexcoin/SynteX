                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SynteX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SYX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and syntex: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SynteX Core"), this);
    aboutAction->setStatusTip(tr("Show information about SynteX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SynteX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SYX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SYX addresses"));
    ...
    openAction->setStatusTip(tr("Open a syntex: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SynteX Core help message to get a list with possible SynteX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SynteX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SynteX network", "", count));
}
...
{
    QString strTitle = tr("SynteX Core"); // default title
