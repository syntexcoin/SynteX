...
This mechanism has been integrated into Bitcore-Node-SynteX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/syntex/insight-api-syntex#web-socket-api](https://github.com/syntex/insight-api-syntex#web-socket-api)
* API: [https://github.com/syntex/insight-api-syntex#swifttx-transactions](https://github.com/syntex/insight-api-syntex#swifttx-transactions)
...
By default, the SynteX Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SynteX Core daemon:
