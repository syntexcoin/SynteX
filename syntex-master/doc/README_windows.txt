...
Intro
-----
SynteX (SYX) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. SynteX utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run syntex-qt.exe.

SynteX Core is the original SynteX client and it builds the backbone of the network.
However, it downloads and stores the entire history of SynteX transactions;
