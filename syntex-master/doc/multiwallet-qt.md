...
In order to support loading of multiple wallets in syntex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is syntex.cpp.
...
Changes to syntex.cpp
----------------------
syntex.cpp is the entry point into syntex-qt, and as such, will require some minor modifications to provide hooks for
